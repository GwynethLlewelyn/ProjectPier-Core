CREATE TABLE `{$tp}contacts` (
  ...
  `avatar_file` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `{$tp}contact_im_values` (
  ...
  `im_value` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `{$tp}page_attachments` (
  ...
  `rel_object_manager` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `project_id` int(10) unsigned NOT NULL,
  `page_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
ALTER TABLE `{$tp}companies` ADD `description` text COLLATE utf8mb4_unicode_ci AFTER `name`;
...
ALTER TABLE `{$tp}project_users` ADD `note` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci AFTER `user_id`;
...
ALTER TABLE `{$tp}project_links` ADD `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci AFTER `url`;
ALTER TABLE `{$tp}project_links` ADD `folder_id` int(10) unsigned not null default '0' AFTER `url`;
ALTER TABLE `{$tp}project_links` ADD `logo_file` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' AFTER `description`;
...
ALTER TABLE `{$tp}companies` CHANGE `country`  `country` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `{$tp}companies` CHANGE `fax_number`  `fax_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `{$tp}companies` CHANGE `id` `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
ALTER TABLE `{$tp}companies` CHANGE `logo_file`  `logo_file` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `{$tp}companies` CHANGE `phone_number`  `phone_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `{$tp}companies` CHANGE `fax_number`  `fax_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `{$tp}companies` CHANGE `timezone`  `timezone` float(4,2) default '0.00';
ALTER TABLE `{$tp}companies` CHANGE `zipcode`  `zipcode` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
...
ALTER TABLE `{$tp}im_types` CHANGE `icon`  `icon` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
ALTER TABLE `{$tp}im_types` CHANGE `id` `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
ALTER TABLE `{$tp}im_types` CHANGE `name`  `name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL;
...
ALTER TABLE `{$tp}project_file_revisions` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_tickets` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_times` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_files` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}tags` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}wiki_pages` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}wiki_revisions` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_categories` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_folders` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_links` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_ticket_changes` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE `{$tp}project_ticket_subscriptions` CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
